...
def query_url(helper, jira_url, jira_username, jira_password, ssl_certificate_validation):
    ...
    # Get splunkd port
    entity = splunk.entity.getEntity('/server', 'settings', namespace='TA-jira-service-desk-simple-addon-mck',
            ...
            if response.status_code not in (200, 201, 204):
                ...
                record_url = 'https://localhost:' + str(
                    splunkd_port) + '/servicesNS/nobody/' \
                                    'TA-jira-service-desk-simple-addon-mck/storage/collections/data/' \
